...
namespace FacilityManagement.Areas.AdminManagement.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        // GET: AdminManagement/Rooms
        public async Task<IActionResult> Index()
        {
            var facilityManagementContext = _context.Rooms.Include(r => r.Building);
            return View(await facilityManagementContext.ToListAsync());
        }

        // GET: AdminManagement/Rooms/Details/5
        ...
        // POST: AdminManagement/Rooms/Create
        ...
        // GET: AdminManagement/Rooms/Edit/5
        ...
        // POST: AdminManagement/Rooms/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminManagement/Rooms/Delete/5
        ...
        // POST: AdminManagement/Rooms/Delete/5
